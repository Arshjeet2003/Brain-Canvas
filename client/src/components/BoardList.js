...
const BoardList = (props) => {
  ...
  return (
    ...
    <div>
        ...
        <form onSubmit={handleNewBoardCreation}>
    ...
    <div className="bodyOfBoardList">
      ...
      <div className="row mt-3 mx-4 heading">
        <div className="col-4">
          <strong>
            <h3>Team Name : </h3>
          </strong>
          <span className="heading2">{boards.name}</span>
        </div>
        <div className="col-4">
          <strong>
            <h3>Team Code : </h3>
          </strong>
          <span className="heading2">{boards.code}</span>
        </div>
      </div>
